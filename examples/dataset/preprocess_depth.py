...
def parse_args() -> argparse.Namespace:
    ...
    # parser.add_argument("--input-root", required=False, default="/mnt/data1/ssy/render_people/fill-light-dataset/test")
    # parser.add_argument("--output-root", required=False, default="/mnt/data1/ssy/render_people/fill-light-dataset/test")
    # parser.add_argument("--input-root", required=False, default="/mnt/data1/ssy/render_people/fill-light-dataset/train-re")
    # parser.add_argument("--output-root", required=False, default="/mnt/data1/ssy/render_people/fill-light-dataset/train-re")
    parser.add_argument("--input-root", required=False, default="/mnt/data1/ssy/render_people/fill-light-dataset/train-self")
    parser.add_argument("--output-root", required=False, default="/mnt/data1/ssy/render_people/fill-light-dataset/train-self")
