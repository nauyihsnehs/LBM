...
def main(
    ...
    task_dir = resolve_task_dir(save_ckpt_path, "albedo")
    ...
    run_name = create_run_name("Albedo")
...
def main_from_config(path_config: str = None):
    ...
    logging.info(f"Running main with config: {yaml.dump(config, default_flow_style=False)}")
